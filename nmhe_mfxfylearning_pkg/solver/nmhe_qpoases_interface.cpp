...
int nmhe_solve( void )
{
	...
	returnValue retVal = qp.init(nmheWorkspace.H, nmheWorkspace.g, nmheWorkspace.A, nmheWorkspace.lb, nmheWorkspace.ub, nmheWorkspace.lbA, nmheWorkspace.ubA, nmhe_nWSR);
